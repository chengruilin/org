...
**** WXBridgeManager -> createInstance
     ...
     #+END_SRC
     这里最终处理完交给 WXBridge 来调用 execJS -> nativeExecJS: [[weex_core_render][传送门]]
...
***** 默认注册的 IPCHandler
      | Enum Msg Value      | Handler Value               | Function(Ignore arguments)                        | Source File   |
      |---------------------+-----------------------------+---------------------------------------------------+---------------|
      | SETJSFVERSION       | HandleSetJSVersion          | @CalledByNative public void setJSFrmVersion()     | WXBridge.java |
      | REPORTEXCEPTION     | HandleReportException       | @CalledByNative public void reportJSException()   | WXBridge.java |
      | CALLNATIVE          | HandleCallNative            | @CalledByNative public int callNative()           | WXBridge.java |
      | CALLNATIVEMODULE    | HandleCallNativeModule      | @CalledByNative public Object callNativeModule()  | WXBridge.java |
      | CALLNATIVECOMPONENT | HandleCallNativeComponent   | @CalledByNative public void callNativeComponent() | WXBridge.java |
      | CALLADDELEMENT      | HandleCallAddElement        | @CalledByNative public int callAddElement()       | WXBridge.java |
      | SETTIMEOUT          | HandleSetTimeout            | @CalledByNative public void setTimeoutNative()    | WXBridge.java |
      | NATIVELOG           | HandleCallNativeLog         |                                                   | WXBridge.java |
      | CALLCREATEBODY      | FunctionCallCreateBody      |                                                   | WXBridge.java |
      | CALLUPDATEFINISH    | FunctionCallUpdateFinish    |                                                   | WXBridge.java |
      | CALLCREATEFINISH    | FunctionCallCreateFinish    |                                                   | WXBridge.java |
      | CALLREFRESHFINISH   | FunctionCallRefreshFinish   |                                                   | WXBridge.java |
      | CALLUPDATEATTRS     | FunctionCallUpdateAttrs     |                                                   | WXBridge.java |
      | CALLUPDATESTYLE     | FunctionCallUpdateStyle     |                                                   | WXBridge.java |
      | CALLREMOVEELEMENT   | FunctionCallRemoveElement   |                                                   | WXBridge.java |
      | CALLMOVEELEMENT     | FunctionCallMoveElement     |                                                   | WXBridge.java |
      | CALLADDEVENT        | FunctionCallAddEvent        |                                                   | WXBridge.java |
      | CALLREMOVEEVENT     | FunctionCallRemoveEvent     |                                                   | WXBridge.java |
      | CALLGCANVASLINK     | HandleCallGCanvasLinkNative |                                                   | WXBridge.java |
      | CALLT3DLINK         | HandleT3DLinkNative         |                                                   | WXBridge.java |
      | SETINTERVAL         | HandleSetInterval           |                                                   | WXBridge.java |
      | CLEARINTERVAL       | HandleClearInterval         |                                                   | WXBridge.java |
      | POSTMESSAGE         | HandlePostMessage           |                                                   | WXBridge.java |
      | DISPATCHMESSAGE     | HandleDispatchMessage       |                                                   | WXBridge.java |
